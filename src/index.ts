...
function createDatasetItem(label: string, button: string) {
...
class DatasetWidget extends Widget {
  ...
  protected async doSearch() {
    ...
    try {
      ...
      this.availHeader.innerText = `Available Datasets (${datasets.length} of ${total})`;
    } catch (e) {
